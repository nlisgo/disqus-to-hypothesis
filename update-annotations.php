...
if ($limit > 0) {
    $update_json = array_slice($update_json, $offset, $limit, true);
}
...
for ($i = 0; $i < $total; $i += $group_limit) {
    ...
    patch_annotations($items, $co, $target_base_uri, $alternative_base_uri, $hypothesis_authority, $hypothesis_client_id_jwt, $hypothesis_secret_key_jwt, $hypothesis_api);
